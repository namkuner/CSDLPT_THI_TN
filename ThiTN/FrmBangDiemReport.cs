...
namespace ThiTN
{
    public partial class FrmBangDiemReport : Form
    {
        ...
        {
            BangDiemReport bangDiemReport = new BangDiemReport(cmbML.SelectedValue.ToString(), cmbMH.SelectedValue.ToString(), int.Parse(cmbLan.SelectedText.ToString().Trim()));
            bangDiemReport.titleBangDiem.Text = "Bảng điểm lớp " + cmbML.SelectedText.ToString() + " cho môn học " + cmbMH.Text.ToString() + " lần thi thứ " + cmbLan.Text.ToString();
